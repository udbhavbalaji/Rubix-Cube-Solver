...
POSSIBLE_ROTATIONS = [
    PossibleRotations.ROTATE_UP,
    PossibleRotations.ROTATE_DOWN,
    PossibleRotations.ROTATE_LEFT_VERTICALLY,
    PossibleRotations.ROTATE_LEFT_HORIZONTALLY,
    PossibleRotations.ROTATE_RIGHT_VERTICALLY,
    PossibleRotations.ROTATE_RIGHT_HORIZONTALLY,
    PossibleRotations.INVERT_VERTICALLY,
    PossibleRotations.INVERT_HORIZONTALLY,
]

POSSIBLE_SHIFTS = [
    PossibleShifts.RIGHT_COL_UP,
    PossibleShifts.RIGHT_COL_DOWN,
    PossibleShifts.LEFT_COL_UP,
    PossibleShifts.LEFT_COL_DOWN,
    PossibleShifts.TOP_ROW_LEFT,
    PossibleShifts.TOP_ROW_RIGHT,
    PossibleShifts.BOTTOM_ROW_LEFT,
    PossibleShifts.BOTTOM_ROW_RIGHT,
]
